...
async function getOauthToken() {
    const body = {
        email: (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput)('email'),
        api_key: (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput)('api-key')
    };
    ...
    return await node_fetch__WEBPACK_IMPORTED_MODULE_0___default()(`${ apiUri }/oauth/access_token`, options).then(res => res.json());
}

async function deployChanges(token) {
    const body = {
        server_id: (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput)('server-id'),
        app_id: (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput)('app-id'),
        branch_name: (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput)('branch-name'),
        deploy_path: (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput)('deploy-path'),
    };
    ...
    return await node_fetch__WEBPACK_IMPORTED_MODULE_0___default()(`${ apiUri }/git/pull`, options).then(response => {
        return response.json().then(data => {
            (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.info)(`Success. Operation ID: ${ response.status }`);
            return {
                ok: response.ok,
...
async function run() {
    try {
        ...
        await deployChanges(oauthToken.access_token).then(response => {
            ...
            (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.info)(`Success. Operation ID: ${ response.body.operation_id }`);
            (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.setOutput)('operation', response.body.operation_id);
        });
    } catch (error) {
